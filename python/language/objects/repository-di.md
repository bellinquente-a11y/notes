...
Use [`Protocol`](oop.md) (structural typing), not ABC. Implementations don't need to inherit — they just need the right methods.
...
- [testing-patterns.md](../../tooling/testing-patterns.md) — seams, `tmp_path`, in-memory DB strategies
