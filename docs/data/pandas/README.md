...
|------|------|-------------|
| [chaining.md](chaining.md) | note | Method chaining — `.assign`, `.pipe`, `.query`, full operation catalog |
| [display.md](display.md) | ref | Print formatting: display options, per-column formatters, DatetimeIndex, df.style |
