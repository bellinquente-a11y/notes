...
- [`contract-tests.md`](contract-tests.md) — one Protocol, many implementations, parametrized fixtures
- [`mocking.md`](mocking.md) — MagicMock, patch, network mocking, AsyncMock, pytest-asyncio
