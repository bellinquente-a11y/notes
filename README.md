...
|-----------|-------------|
| [data/](data/) | NumPy and Pandas — arrays, vectorised operations, DataFrames |
...
│   │   └── [dtypes.md](data/numpy/dtypes.md)\
│   └── pandas/\
...
├── finance/\
│   ├── [binance.md](finance/binance.md)\
│   └── [market-data-apis.md](finance/market-data-apis.md)\
├── git/\
│   ├── [git.md](git/git.md)\
...
│   │   │   ├── [iterators-generators.md](python/language/functional/iterators-generators.md)\
│   │   │   ├── [lazy-evaluation.md](python/language/functional/lazy-evaluation.md)\
